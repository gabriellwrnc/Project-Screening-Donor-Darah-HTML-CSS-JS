            ...
            <div class="form signinForm">
				...
				<?php
					...
					if(isset($_POST['login'])){
						$log_username = htmlspecialchars($_POST['login_username']);
            ...
            <div class="form signupForm">
				...
				<?php
					...
					if(isset($_POST["daftar"])){
						$username = htmlspecialchars($_POST['daftar_username']);
						$password = htmlspecialchars($_POST['daftar_password']);
						$cpassword = htmlspecialchars($_POST['daftar_cpassword']);
